...
puts "=== Adding users... ==="
user1 = User.create(first_name: 'Ben', last_name: 'Moro', email: 'benjamin@com', password: 'azerty')
...
user1.save
user2 = User.create(first_name: 'Tatoune', last_name: 'Ajar', email: 'tania@com', password: 'azerty')
...
user2.save
user3 = User.create(first_name: 'Robinho', last_name: 'Daen', email: 'robin@com', password: 'azerty')
...
user3.save
user4 = User.create(first_name: 'Loulou', last_name: 'Ok', email: 'louis@com', password: 'azerty')
...
puts "=== Adding boats... ==="
boat1 = Boat.create(title: "Amazing boat to sail",category:"⛵ sailboat",brand:"X",location:"Port Tino Rossi", length:25,price_per_day:200,capacity:14, building_year:2010, user_id: user1.id)
...
boat2.save
boat3 = Boat.create(title: "Sail this wonder",category:"⛵ sailboat",brand:"X",location:"Nice", length:45,price_per_day:150,capacity:15, building_year:2016, user_id: user3.id)
...
boat3.save
boat4 = Boat.create(title: "Enjoy the sea with me",category:"🚤 motorboat",brand:"Jeanneau",location:"Toulon", length:10,price_per_day:80,capacity:7, building_year:2011, user_id: user4.id)
...
boat6.save
boat7 = Boat.create(title: "Sail a great boat",category:"⛵ sailboat",brand:"X",location:"1 Rue de la Vieille Jetée, 17200 Royan", length:32,price_per_day:250,capacity:12, building_year:2007, user_id: user3.id)
...
boat7.save
boat8 = Boat.create(title: "Enjoy your holiday on me",category:"🚤 motorboat",brand:"Dufour",location:"Brest", length:8,price_per_day:90,capacity:5, building_year:2013, user_id: user4.id)
