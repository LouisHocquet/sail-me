...
boat4.save
boat5 = Boat.create(title: "Amazing boat to sail",category:"⛵ sailboat",brand:"X",location:"20200 Bastia", length:45,price_per_day:65,capacity:6, building_year:2010, user_id: user1.id)
...
boat5.save
boat6 = Boat.create(title: "Best boat ever had",category:"🚤 motorboat",brand:"X",location:"port de Marseille", length:45,price_per_day:65,capacity:6, building_year:2010, user_id: user2.id)
...
boat6.save
boat7 = Boat.create(title: "Sail this wonder",category:"⛵ sailboat",brand:"X",location:"1 Rue de la Vieille Jetée, 17200 Royan", length:45,price_per_day:65,capacity:6, building_year:2010, user_id: user3.id)
...
boat7.save
boat8 = Boat.create(title: "Enjoy the sea with me",category:"🚤 motorboat",brand:"X",location:"Brest", length:45,price_per_day:65,capacity:6, building_year:2010, user_id: user4.id)
